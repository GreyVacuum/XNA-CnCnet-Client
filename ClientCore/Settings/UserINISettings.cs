...
namespace ClientCore
{
    public class UserINISettings
    {
        ...
        protected UserINISettings(IniFile iniFile)
        {
            ...
            PreferredCnCNetTunnel = new StringSetting(iniFile, MULTIPLAYER, "PreferredCnCNetTunnel", string.Empty);
            ...
            EnableBackgroundVideoSound = new BoolSetting(iniFile, VIDEO, "EnableBackgroundVideoSound", false);
        ...
        public StringSetting PreferredCnCNetTunnel { get; private set; }
